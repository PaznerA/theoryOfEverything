...
This is a direct numerical demonstration of the central thesis: the SJ state is well-defined to machine precision inside a rotating ergoregion where $\partial_t$ is spacelike, exactly where the static analogue degenerates and where no symmetric Hadamard vacuum exists.
...
13. M. Dafermos, J. Luk et al., *The Unruh state for the Teukolsky field on Kerr — existence and Hadamard property*, arXiv:2602.09796.
