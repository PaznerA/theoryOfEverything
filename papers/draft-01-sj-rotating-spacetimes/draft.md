...
- **SJ non-Hadamard caveat.** Generic SJ states are not Hadamard (Fewster–Verch, arXiv:1106.4785, arXiv:1307.5242). We measure existence and directional signatures, not UV structure, so this does not affect the claims here; a softened-SJ variant (Zhu–Yazdi, arXiv:2212.10592) restoring the Hadamard property at the cost of strict uniqueness is the natural extension for UV-sensitive observables.
...
5. E. Kastrati and H. Hinrichsen, *Numerical Evaluation of the Causal Set Propagator in 2D Anti-de Sitter Spacetime*, arXiv:2504.12919. [conformal flatness $\Rightarrow$ $\tfrac12 C$ in curved 2D / AdS$_2$]
...
7. Y. R. Zhu and Y. K. Yazdi, *On the (Non)Hadamard Property of the SJ State in a 1+1D Causal Diamond*, arXiv:2212.10592. [softened SJ, Hadamard recovery]
...
12. V. Balakumar, R. P. Bernar and E. Winstanley, *Superradiance and quantum states on black hole space-times*, arXiv:2303.13488. [superradiance obstruction to standard vacua]
13. D. Häfner and C. K. M. Klein, *The Unruh state for bosonic Teukolsky fields on subextreme Kerr spacetimes*, arXiv:2602.09796.
14. Y. Shlapentokh-Rothman and R. Teixeira da Costa, *Boundedness and decay for the Teukolsky equation on Kerr in the full subextremal range $|a|<M$*, arXiv:2007.07211.
